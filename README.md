...
[deepcopy-gen](https://github.com/kubernetes/code-generator/tree/master/cmd/deepcopy-gen) and keepalive-gen used DDD </br>
[deepcopy-gen](https://github.com/kubernetes/code-generator/tree/master/cmd/deepcopy-gen) 配合keepalive-gen实现DDD 模式开发
...
use gen-proto-error to generate errmsg <br>
使用 gen-proto-error 生成errmsg代码和文件可以解决多语言和错误堆栈等问题
详情可以看<br> [gen-proto-error](https://github.com/ravinggo/tools/blob/main/gen-proto-error/README.md)
