...
// +k8s:deepcopy-gen:interfaces=github.com/ravinggo/game/common/tools/deepcopy-gen/output_tests_no_ka/aliases.Interface
// +k8s:deepcopy-gen:interfaces=github.com/ravinggo/game/common/tools/deepcopy-gen/output_tests_no_ka/aliases.AliasInterface
// +k8s:deepcopy-gen:interfaces=github.com/ravinggo/game/common/tools/deepcopy-gen/output_tests_no_ka/aliases.AliasAliasInterface
type Foo struct {
	X int
}
