...
// +k8s:deepcopy-gen:interfaces=github.com/ravinggo/game/common/tools/deepcopy-gen/output_tests/aliases.Interface
// +k8s:deepcopy-gen:interfaces=github.com/ravinggo/game/common/tools/deepcopy-gen/output_tests/aliases.AliasInterface
// +k8s:deepcopy-gen:interfaces=github.com/ravinggo/game/common/tools/deepcopy-gen/output_tests/aliases.AliasAliasInterface
type Foo struct {
	X int
}
