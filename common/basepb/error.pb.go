...
type ErrorMessage struct {
	...
	// from_message_name 标明该错误来自哪个请求
	FromMessageName string `protobuf:"bytes,6,opt,name=from_message_name,json=fromMessageName,proto3" json:"from_message_name,omitempty"`
}
...
func (m *ErrorMessage) GetFromMessageName() string {
	if m != nil {
		return m.FromMessageName
	}
	return ""
}
...
var fileDescriptor_0579b252106fcf4a = []byte{
	...
	,
}
...
func (m *ErrorMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.FromMessageName) > 0 {
		i -= len(m.FromMessageName)
		copy(dAtA[i:], m.FromMessageName)
		i = encodeVarintError(dAtA, i, uint64(len(m.FromMessageName)))
		i--
		dAtA[i] = 0x32
	}
...
func (m *ErrorMessage) MarshalEasyJSON(w *github_com_mailru_easyjson_jwriter.Writer) {
	...
	if m.FromMessageName != "" {
		if needWriteComma {
			w.RawByte(',')
		}
		w.RawByte('"')
		w.RawString("from_message_name")
		w.RawByte('"')
		w.RawByte(':')
		w.String(m.FromMessageName)
		needWriteComma = true
	}
	_ = needWriteComma
	w.RawByte('}')
...
func (m *ErrorMessage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FromMessageName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FromMessageName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipError(dAtA[iNdEx:])
